"""
Downloads and creates data manifest files for CN Celeb (spk-id).
...
def create_json(wav_list, json_file):
    """
    Creates the json file given a list of CN_Celeb files.

    Arguments
    ---------
    wav_list : list of str
        The list of CN_Celeb files.
    json_file : str
        The path of the output json file
    """
    # Processing all the CN_Celeb files in the list
    json_dict = {}
    ...
    file =  json_file
    with open(file, mode="w") as json_f:
...
def split_sets(wav_list, split_ratio):
    """Randomly splits the CN_Celeb list into training, validation, and test lists.
